 ...
 */
@RestController
@Api(tags = "后台用户收藏接口", value = "CollectBackGroundController")
public class CollectBackGroundController {
    private static final Logger logger = LoggerFactory.getLogger(CollectBackGroundController.class);
    ...
    @PostMapping("/collectBackGround/insertCollect")
    ...
    @DeleteMapping("/collectBackGround/deleteCollect")
    ...
    @DeleteMapping("/collectBackGround/deleteAll")
    ...
    @GetMapping("/collectBackGround/selectCollect")
