 ...
 */
@RestController
@Api(tags = "前台用户接口", value = "UserFrontDeskController")
public class UserFrontDeskController {
    ...
    @PostMapping("/userFrontDesk/insertUser")
    ...
    @GetMapping("/userFrontDesk/selectUser")
    public RespBean select(String memberPhone, String memberPassword) throws Exception {
    ...
    @PutMapping("/userFrontDesk/updateUserPassWord")
    @ApiImplicitParams({
    ...
    @PutMapping("/userFrontDesk/forgetPassWord")
    @ApiImplicitParams({
    ...
    @DeleteMapping("/userFrontDesk/deleteUser")
    @ApiImplicitParams({
    ...
    @PostMapping("/userFrontDesk/sendEmail")
