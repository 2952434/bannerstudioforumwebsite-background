 ...
 */
@RestController
@Api(tags = "前台用户收藏接口", value = "CollectFrontDeskController")
public class CollectFrontDeskController {
    private static final Logger logger = LoggerFactory.getLogger(CollectFrontDeskController.class);
    ...
    @PostMapping("/collectFrontDesk/insertCollect")
    ...
    @DeleteMapping("/collectFrontDesk/deleteCollect")
    ...
    @DeleteMapping("/collectFrontDesk/deleteAll")
    ...
    @GetMapping("/collectFrontDesk/selectCollect")
