 ...
 */
@RestController
@Api(tags = "前台统计在线人数", value = "ListenerFrontDeskController")
public class ListenerFrontDeskController {
    private static final Logger logger = LoggerFactory.getLogger(ListenerFrontDeskController.class);
    /**
     * 登录
     */
    @Autowired
    ...
    @PostMapping("/listenerFrontDesk/login")
    ...
    @GetMapping("/listenerFrontDesk/logout")
    ...
    @GetMapping("/listenerFrontDesk/getSession")
